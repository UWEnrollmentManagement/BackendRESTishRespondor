...
class SettingTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'FormsAPI.Map.SettingTableMap';
     ...
     */
    const OM_CLASS = '\\FormsAPI\\Setting';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FormsAPI.Setting';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Key', 'Value', ),
        self::TYPE_CAMELNAME     => array('id', 'key', 'value', ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_ID, SettingTableMap::COL_KEY, SettingTableMap::COL_VALUE, ),
        self::TYPE_FIELDNAME     => array('id', 'key', 'value', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Key' => 1, 'Value' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'key' => 1, 'value' => 2, ),
        self::TYPE_COLNAME       => array(SettingTableMap::COL_ID => 0, SettingTableMap::COL_KEY => 1, SettingTableMap::COL_VALUE => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'key' => 1, 'value' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FormsAPI\\Setting');
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'key','validator' => 'NotNull',), 'rule2' => array ('column' => 'value','validator' => 'NotNull',), ),
        );
    } // getBehaviors()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingTableMap::COL_KEY);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \FormsAPI\Setting) { // it's a model object

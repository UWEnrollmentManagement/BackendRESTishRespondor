...
class NoteTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'FormsAPI.Map.NoteTableMap';
     ...
     */
    const OM_CLASS = '\\FormsAPI\\Note';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FormsAPI.Note';
     ...
     */
    const COL_SUBJECT = 'note.subject';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID, NoteTableMap::COL_CONTENT, NoteTableMap::COL_SUBJECT, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(NoteTableMap::COL_ID => 0, NoteTableMap::COL_CONTENT => 1, NoteTableMap::COL_SUBJECT => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FormsAPI\\Note');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NoteTableMap::COL_SUBJECT);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \FormsAPI\Note) { // it's a model object

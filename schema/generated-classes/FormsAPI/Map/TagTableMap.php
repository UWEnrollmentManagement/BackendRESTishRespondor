...
class TagTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'FormsAPI.Map.TagTableMap';
     ...
     */
    const OM_CLASS = '\\FormsAPI\\Tag';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FormsAPI.Tag';
     ...
     */
    const COL_DEFAULT_MESSAGE = 'tag.default_message';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID, TagTableMap::COL_NAME, TagTableMap::COL_DEFAULT_MESSAGE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TagTableMap::COL_ID => 0, TagTableMap::COL_NAME => 1, TagTableMap::COL_DEFAULT_MESSAGE => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FormsAPI\\Tag');
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TagTableMap::COL_DEFAULT_MESSAGE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \FormsAPI\Tag) { // it's a model object

...
class SettingsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'FormsAPI.Map.SettingsTableMap';
     ...
     */
    const OM_CLASS = '\\FormsAPI\\Settings';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FormsAPI.Settings';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID, SettingsTableMap::COL_KEY, SettingsTableMap::COL_VALUE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SettingsTableMap::COL_ID => 0, SettingsTableMap::COL_KEY => 1, SettingsTableMap::COL_VALUE => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FormsAPI\\Settings');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SettingsTableMap::COL_KEY);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \FormsAPI\Settings) { // it's a model object

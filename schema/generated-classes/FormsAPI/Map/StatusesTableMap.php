...
class StatusesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'FormsAPI.Map.StatusesTableMap';
     ...
     */
    const OM_CLASS = '\\FormsAPI\\Statuses';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'FormsAPI.Statuses';
     ...
     */
    const COL_ID = 'statuses.id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'statuses.name';

    /**
     * the column name for the default_message field
     */
    const COL_DEFAULT_MESSAGE = 'statuses.default_message';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(StatusesTableMap::COL_ID, StatusesTableMap::COL_NAME, StatusesTableMap::COL_DEFAULT_MESSAGE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(StatusesTableMap::COL_ID => 0, StatusesTableMap::COL_NAME => 1, StatusesTableMap::COL_DEFAULT_MESSAGE => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\FormsAPI\\Statuses');
        $this->setPackage('FormsAPI');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('name', 'Name', 'VARCHAR', true, 63, null);
        $this->addColumn('default_message', 'DefaultMessage', 'VARCHAR', true, 1683, null);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(StatusesTableMap::COL_DEFAULT_MESSAGE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \FormsAPI\Statuses) { // it's a model object

...
class VisitorTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addColumn('uw_student_number', 'UWStudentNumber', 'VARBINARY', false, 7, null);
        $this->addColumn('uw_net_id', 'UWNetID', 'VARBINARY', true, 63, null);
        $this->addColumn('first_name', 'FirstName', 'VARBINARY', false, 63, null);
        $this->addColumn('middle_name', 'MiddleName', 'VARBINARY', false, 63, null);
        $this->addColumn('last_name', 'LastName', 'VARBINARY', false, 63, null);
    } // initialize()

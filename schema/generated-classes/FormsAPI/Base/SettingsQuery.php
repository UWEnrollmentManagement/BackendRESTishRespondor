...
use \Exception;
use \PDO;
use FormsAPI\Settings as ChildSettings;
use FormsAPI\SettingsQuery as ChildSettingsQuery;
use FormsAPI\Map\SettingsTableMap;
 ...
 * @method     ChildSettingsQuery orderByKey($order = Criteria::ASC) Order by the key column
 ...
 * @method     ChildSettingsQuery groupByKey() Group by the key column
 ...
 * @method     ChildSettings findOneByKey(string $key) Return the first ChildSettings filtered by the key column
 ...
 * @method     ChildSettings requireOneByKey(string $key) Return the first ChildSettings filtered by the key column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSettings[]|ObjectCollection findByKey(string $key) Return ChildSettings objects filtered by the key column
...
abstract class SettingsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \FormsAPI\Base\SettingsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\FormsAPI\\Settings', $modelAlias = null)
    {
    ...
    public function filterByKey($key = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingsTableMap::COL_KEY, $key, $comparison);
    }

...
/**
 * Base class that represents a row from the 'recipient' table.
 *
 *
 *
 * @package    propel.generator.FormsAPI.Base
 */
abstract class Recipient implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\RecipientTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\Recipient object.
     */
    ...
    /**
     * Compares this with another <code>Recipient</code> instance.  If
     * <code>obj</code> is an instance of <code>Recipient</code>, delegates to
     * <code>equals(Recipient)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Recipient The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[RecipientTableMap::COL_ID] = true;
        }
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[RecipientTableMap::COL_ADDRESS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RecipientTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRecipientQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Recipient::setDeleted()
     * @see Recipient::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRecipientQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RecipientTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RecipientTableMap::COL_ID)) {
    ...
    {
        $pos = RecipientTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['Recipient'][$this->hashCode()] = true;
        $keys = RecipientTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\FormsAPI\Recipient
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\Recipient The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RecipientTableMap::COL_ID)) {
            $criteria->add(RecipientTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(RecipientTableMap::COL_ADDRESS)) {
    ...
    {
        $criteria = ChildRecipientQuery::create();
        $criteria->add(RecipientTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\Recipient (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\Recipient Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(RecipientTableMap::DEFAULT_STRING_FORMAT);
    }

...
abstract class Tag implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\TagTableMap';
    ...
    public function setDefaultMessage($v)
    {
        ...
        if ($this->default_message !== $v) {
            ...
            $this->modifiedColumns[TagTableMap::COL_DEFAULT_MESSAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TagTableMap::translateFieldName('DefaultMessage', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\Tag'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_DEFAULT_MESSAGE)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\Tag The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagTableMap::COL_DEFAULT_MESSAGE)) {
            $criteria->add(TagTableMap::COL_DEFAULT_MESSAGE, $this->default_message);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\Tag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\Tag Clone of current object.
     * @throws PropelException
     */

...
/**
 * Base class that represents a row from the 'submission_tag' table.
 *
 *
 *
 * @package    propel.generator.FormsAPI.Base
 */
abstract class SubmissionTag implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\SubmissionTagTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\SubmissionTag object.
     */
    ...
    /**
     * Compares this with another <code>SubmissionTag</code> instance.  If
     * <code>obj</code> is an instance of <code>SubmissionTag</code>, delegates to
     * <code>equals(SubmissionTag)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SubmissionTag The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[SubmissionTagTableMap::COL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SubmissionTagTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SubmissionTagTableMap::translateFieldName('SubmissionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->submission_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SubmissionTagTableMap::translateFieldName('TagId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = SubmissionTagTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\SubmissionTag'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSubmissionTagQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SubmissionTag::setDeleted()
     * @see SubmissionTag::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSubmissionTagQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SubmissionTagTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SubmissionTagTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(SubmissionTagTableMap::COL_SUBMISSION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'submission_id';
        }
        if ($this->isColumnModified(SubmissionTagTableMap::COL_TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = 'tag_id';
        }

        $sql = sprintf(
            'INSERT INTO submission_tag (%s) VALUES (%s)',
    ...
    {
        $pos = SubmissionTagTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['SubmissionTag'][$this->hashCode()] = true;
        $keys = SubmissionTagTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\FormsAPI\SubmissionTag
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\SubmissionTag The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SubmissionTagTableMap::COL_ID)) {
            $criteria->add(SubmissionTagTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(SubmissionTagTableMap::COL_SUBMISSION_ID)) {
            $criteria->add(SubmissionTagTableMap::COL_SUBMISSION_ID, $this->submission_id);
        }
        if ($this->isColumnModified(SubmissionTagTableMap::COL_TAG_ID)) {
            $criteria->add(SubmissionTagTableMap::COL_TAG_ID, $this->tag_id);
        }
    ...
    {
        $criteria = ChildSubmissionTagQuery::create();
        $criteria->add(SubmissionTagTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\SubmissionTag (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\SubmissionTag Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(SubmissionTagTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    {
        $metadata->addPropertyConstraint('submission_id', new NotNull());

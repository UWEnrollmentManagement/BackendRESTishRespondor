...
use \Exception;
use \PDO;
use FormsAPI\Setting as ChildSetting;
 ...
 * @method     ChildSettingQuery orderByKey($order = Criteria::ASC) Order by the key column
 ...
 * @method     ChildSettingQuery groupByKey() Group by the key column
 ...
 * @method     ChildSetting findOneByKey(string $key) Return the first ChildSetting filtered by the key column
 ...
 * @method     ChildSetting requireOneByKey(string $key) Return the first ChildSetting filtered by the key column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildSetting[]|ObjectCollection findByKey(string $key) Return ChildSetting objects filtered by the key column
...
abstract class SettingQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \FormsAPI\Base\SettingQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\FormsAPI\\Setting', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, key, value FROM setting WHERE id = :p0';
        try {
    ...
    public function filterByKey($key = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SettingTableMap::COL_KEY, $key, $comparison);
    }

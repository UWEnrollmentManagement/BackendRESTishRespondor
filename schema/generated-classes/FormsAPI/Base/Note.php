...
abstract class Note implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\NoteTableMap';
    ...
    public function setSubject($v)
    {
        ...
        if ($this->subject !== $v) {
            $this->subject = $v;
            $this->modifiedColumns[NoteTableMap::COL_SUBJECT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : NoteTableMap::translateFieldName('Content', TableMap::TYPE_PHPNAME, $indexType)];
            $this->content = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : NoteTableMap::translateFieldName('Subject', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = NoteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\Note'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(NoteTableMap::COL_SUBJECT)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\Note The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NoteTableMap::COL_SUBJECT)) {
            $criteria->add(NoteTableMap::COL_SUBJECT, $this->subject);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\Note (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\Note Clone of current object.
     * @throws PropelException
     */

...
/**
 * Base class that represents a row from the 'dashboard_form' table.
 *
 *
 *
 * @package    propel.generator.FormsAPI.Base
 */
abstract class DashboardForm implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\DashboardFormTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\DashboardForm object.
     */
    ...
    /**
     * Compares this with another <code>DashboardForm</code> instance.  If
     * <code>obj</code> is an instance of <code>DashboardForm</code>, delegates to
     * <code>equals(DashboardForm)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DashboardForm The current object, for fluid interface
     */
     ...
     * @return $this|\FormsAPI\DashboardForm The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DashboardFormTableMap::COL_ID] = true;
        }
    ...
    public function setDashboardId($v)
    {
        ...
        if ($this->dashboard_id !== $v) {
            $this->dashboard_id = $v;
            $this->modifiedColumns[DashboardFormTableMap::COL_DASHBOARD_ID] = true;
        }
    ...
    public function setFormId($v)
    {
        ...
        if ($this->form_id !== $v) {
            $this->form_id = $v;
            $this->modifiedColumns[DashboardFormTableMap::COL_FORM_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DashboardFormTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DashboardFormTableMap::translateFieldName('DashboardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dashboard_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DashboardFormTableMap::translateFieldName('FormId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = DashboardFormTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\DashboardForm'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDashboardFormQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DashboardForm::setDeleted()
     * @see DashboardForm::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDashboardFormQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DashboardFormTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DashboardFormTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DashboardFormTableMap::COL_DASHBOARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'dashboard_id';
        }
        if ($this->isColumnModified(DashboardFormTableMap::COL_FORM_ID)) {
            $modifiedColumns[':p' . $index++]  = 'form_id';
        }

        $sql = sprintf(
            'INSERT INTO dashboard_form (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'dashboard_id':
                        $stmt->bindValue($identifier, $this->dashboard_id, PDO::PARAM_INT);
                        break;
                    case 'form_id':
    ...
    {
        $pos = DashboardFormTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['DashboardForm'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DashboardForm'][$this->hashCode()] = true;
        $keys = DashboardFormTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\FormsAPI\DashboardForm
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setDashboardId($arr[$keys[1]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\DashboardForm The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DashboardFormTableMap::COL_ID)) {
            $criteria->add(DashboardFormTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DashboardFormTableMap::COL_DASHBOARD_ID)) {
            $criteria->add(DashboardFormTableMap::COL_DASHBOARD_ID, $this->dashboard_id);
        }
        if ($this->isColumnModified(DashboardFormTableMap::COL_FORM_ID)) {
            $criteria->add(DashboardFormTableMap::COL_FORM_ID, $this->form_id);
        }
    ...
    {
        $criteria = ChildDashboardFormQuery::create();
        $criteria->add(DashboardFormTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\DashboardForm (or compatible) type.
    ...
    {
        $copyObj->setDashboardId($this->getDashboardId());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\DashboardForm Clone of current object.
     * @throws PropelException
     */
    ...
    public function getDashboard(ConnectionInterface $con = null)
    {
        if ($this->aDashboard === null && ($this->dashboard_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDashboard->addDashboardForms($this);
             */
        }
    ...
    public function getForm(ConnectionInterface $con = null)
    {
        if ($this->aForm === null && ($this->form_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aForm->addDashboardForms($this);
             */
        }
    ...
    {
        if (null !== $this->aDashboard) {
            $this->aDashboard->removeDashboardForm($this);
        }
        if (null !== $this->aForm) {
            $this->aForm->removeDashboardForm($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(DashboardFormTableMap::DEFAULT_STRING_FORMAT);
    }
    ...
    {
        $metadata->addPropertyConstraint('dashboard_id', new NotNull());

...
use \Exception;
use \PDO;
use FormsAPI\Statuses as ChildStatuses;
use FormsAPI\StatusesQuery as ChildStatusesQuery;
use FormsAPI\Map\StatusesTableMap;
 ...
 * @method     ChildStatusesQuery orderByDefaultMessage($order = Criteria::ASC) Order by the default_message column
 *
 * @method     ChildStatusesQuery groupById() Group by the id column
 * @method     ChildStatusesQuery groupByName() Group by the name column
 * @method     ChildStatusesQuery groupByDefaultMessage() Group by the default_message column
 *
 ...
 *
 * @method     ChildStatuses findOneById(int $id) Return the first ChildStatuses filtered by the id column
 * @method     ChildStatuses findOneByName(string $name) Return the first ChildStatuses filtered by the name column
 * @method     ChildStatuses findOneByDefaultMessage(string $default_message) Return the first ChildStatuses filtered by the default_message column *
 ...
 * @method     ChildStatuses requireOneByDefaultMessage(string $default_message) Return the first ChildStatuses filtered by the default_message column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildStatuses[]|ObjectCollection findById(int $id) Return ChildStatuses objects filtered by the id column
 * @method     ChildStatuses[]|ObjectCollection findByName(string $name) Return ChildStatuses objects filtered by the name column
 * @method     ChildStatuses[]|ObjectCollection findByDefaultMessage(string $default_message) Return ChildStatuses objects filtered by the default_message column
...
abstract class StatusesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \FormsAPI\Base\StatusesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\FormsAPI\\Statuses', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, default_message FROM statuses WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(StatusesTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(StatusesTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StatusesTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StatusesTableMap::COL_NAME, $name, $comparison);
    }
    ...
    public function filterByDefaultMessage($defaultMessage = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(StatusesTableMap::COL_DEFAULT_MESSAGE, $defaultMessage, $comparison);
    }

...
abstract class Requirement implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RequirementTableMap::translateFieldName('ElementId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->element_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : RequirementTableMap::translateFieldName('ConditionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->condition_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RequirementTableMap::translateFieldName('FailureMessage', TableMap::TYPE_PHPNAME, $indexType)];

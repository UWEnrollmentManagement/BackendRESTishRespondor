...
/**
 * Base class that represents a row from the 'dashboard_element' table.
 *
 *
 *
 * @package    propel.generator.FormsAPI.Base
 */
abstract class DashboardElement implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\DashboardElementTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\DashboardElement object.
     */
    ...
    /**
     * Compares this with another <code>DashboardElement</code> instance.  If
     * <code>obj</code> is an instance of <code>DashboardElement</code>, delegates to
     * <code>equals(DashboardElement)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|DashboardElement The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DashboardElementTableMap::COL_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : DashboardElementTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DashboardElementTableMap::translateFieldName('DashboardId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dashboard_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DashboardElementTableMap::translateFieldName('ElementId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = DashboardElementTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\DashboardElement'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDashboardElementQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DashboardElement::setDeleted()
     * @see DashboardElement::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildDashboardElementQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                DashboardElementTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DashboardElementTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(DashboardElementTableMap::COL_DASHBOARD_ID)) {
            $modifiedColumns[':p' . $index++]  = 'dashboard_id';
        }
        if ($this->isColumnModified(DashboardElementTableMap::COL_ELEMENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'element_id';
        }

        $sql = sprintf(
            'INSERT INTO dashboard_element (%s) VALUES (%s)',
    ...
    {
        $pos = DashboardElementTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $alreadyDumpedObjects['DashboardElement'][$this->hashCode()] = true;
        $keys = DashboardElementTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\FormsAPI\DashboardElement
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\DashboardElement The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DashboardElementTableMap::COL_ID)) {
            $criteria->add(DashboardElementTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(DashboardElementTableMap::COL_DASHBOARD_ID)) {
            $criteria->add(DashboardElementTableMap::COL_DASHBOARD_ID, $this->dashboard_id);
        }
        if ($this->isColumnModified(DashboardElementTableMap::COL_ELEMENT_ID)) {
            $criteria->add(DashboardElementTableMap::COL_ELEMENT_ID, $this->element_id);
        }
    ...
    {
        $criteria = ChildDashboardElementQuery::create();
        $criteria->add(DashboardElementTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\DashboardElement (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\DashboardElement Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(DashboardElementTableMap::DEFAULT_STRING_FORMAT);
    }

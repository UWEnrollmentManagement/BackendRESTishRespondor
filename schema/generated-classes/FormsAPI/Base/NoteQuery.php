 ...
 * @method     ChildNoteQuery orderBySubject($order = Criteria::ASC) Order by the subject column
 *
 * @method     ChildNoteQuery groupById() Group by the id column
 * @method     ChildNoteQuery groupByContent() Group by the content column
 * @method     ChildNoteQuery groupBySubject() Group by the subject column
 *
 ...
 * @method     ChildNote findOneBySubject(string $subject) Return the first ChildNote filtered by the subject column *
 ...
 * @method     ChildNote requireOneBySubject(string $subject) Return the first ChildNote filtered by the subject column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildNote[]|ObjectCollection findBySubject(string $subject) Return ChildNote objects filtered by the subject column
...
abstract class NoteQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \FormsAPI\Base\NoteQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\FormsAPI\\Note', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, content, subject FROM note WHERE id = :p0';
        try {

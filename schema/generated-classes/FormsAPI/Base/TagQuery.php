 ...
 * @method     ChildTagQuery orderByDefaultMessage($order = Criteria::ASC) Order by the default_message column
 *
 * @method     ChildTagQuery groupById() Group by the id column
 * @method     ChildTagQuery groupByName() Group by the name column
 * @method     ChildTagQuery groupByDefaultMessage() Group by the default_message column
 *
 ...
 * @method     ChildTag findOneByDefaultMessage(string $default_message) Return the first ChildTag filtered by the default_message column *
 ...
 * @method     ChildTag requireOneByDefaultMessage(string $default_message) Return the first ChildTag filtered by the default_message column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildTag[]|ObjectCollection findByDefaultMessage(string $default_message) Return ChildTag objects filtered by the default_message column
...
abstract class TagQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \FormsAPI\Base\TagQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\FormsAPI\\Tag', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, default_message FROM tag WHERE id = :p0';
        try {

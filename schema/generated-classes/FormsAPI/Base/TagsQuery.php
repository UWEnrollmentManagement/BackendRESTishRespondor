...
use \Exception;
use \PDO;
use FormsAPI\Tags as ChildTags;
use FormsAPI\TagsQuery as ChildTagsQuery;
use FormsAPI\Map\TagsTableMap;
 ...
 * @method     ChildTagsQuery orderByDefaultMessage($order = Criteria::ASC) Order by the default_message column
 *
 * @method     ChildTagsQuery groupById() Group by the id column
 * @method     ChildTagsQuery groupByName() Group by the name column
 * @method     ChildTagsQuery groupByDefaultMessage() Group by the default_message column
 *
 ...
 * @method     ChildTags findOneByDefaultMessage(string $default_message) Return the first ChildTags filtered by the default_message column *
 ...
 * @method     ChildTags requireOneByDefaultMessage(string $default_message) Return the first ChildTags filtered by the default_message column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildTags[]|ObjectCollection findByDefaultMessage(string $default_message) Return ChildTags objects filtered by the default_message column
...
abstract class TagsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \FormsAPI\Base\TagsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\FormsAPI\\Tags', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name, default_message FROM tags WHERE id = :p0';
        try {
    ...
    public function filterByDefaultMessage($defaultMessage = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TagsTableMap::COL_DEFAULT_MESSAGE, $defaultMessage, $comparison);
    }

...
abstract class Statuses implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\StatusesTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\Statuses object.
     */
     ...
     * @return $this|\FormsAPI\Statuses The current object (for fluent API support)
     */
    ...
    public function setDefaultMessage($v)
    {
        ...
        if ($this->default_message !== $v) {
            ...
            $this->modifiedColumns[StatusesTableMap::COL_DEFAULT_MESSAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StatusesTableMap::translateFieldName('DefaultMessage', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = StatusesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\Statuses'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StatusesTableMap::COL_DEFAULT_MESSAGE)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\Statuses The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusesTableMap::COL_DEFAULT_MESSAGE)) {
            $criteria->add(StatusesTableMap::COL_DEFAULT_MESSAGE, $this->default_message);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\Statuses (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\Statuses Clone of current object.
     * @throws PropelException
     */

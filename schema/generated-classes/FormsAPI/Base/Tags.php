...
abstract class Tags implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\TagsTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\Tags object.
     */
     ...
     * @return $this|\FormsAPI\Tags The current object (for fluent API support)
     */
    ...
    public function setDefaultMessage($v)
    {
        ...
        if ($this->default_message !== $v) {
            ...
            $this->modifiedColumns[TagsTableMap::COL_DEFAULT_MESSAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TagsTableMap::translateFieldName('DefaultMessage', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\Tags'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TagsTableMap::COL_DEFAULT_MESSAGE)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\Tags The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TagsTableMap::COL_DEFAULT_MESSAGE)) {
            $criteria->add(TagsTableMap::COL_DEFAULT_MESSAGE, $this->default_message);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\Tags (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\Tags Clone of current object.
     * @throws PropelException
     */

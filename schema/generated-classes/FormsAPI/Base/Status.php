...
abstract class Status implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\StatusTableMap';
    ...
    /**
     * The value for the default_message field.
     *
     * @var        string
     */
    ...
    /**
     * Get the [default_message] column value.
     *
     * @return string
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StatusTableMap::COL_ID] = true;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[StatusTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [default_message] column.
     *
     * @param string $v new value
     * @return $this|\FormsAPI\Status The current object (for fluent API support)
     */
    public function setDefaultMessage($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->default_message !== $v) {
            $this->default_message = $v;
            $this->modifiedColumns[StatusTableMap::COL_DEFAULT_MESSAGE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StatusTableMap::translateFieldName('DefaultMessage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->default_message = (null !== $col) ? (string) $col : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = StatusTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\Status'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[StatusTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . StatusTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(StatusTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(StatusTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(StatusTableMap::COL_DEFAULT_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'default_message';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'default_message':
                        $stmt->bindValue($identifier, $this->default_message, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setDefaultMessage($arr[$keys[2]]);
        }
    }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\Status The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatusTableMap::COL_ID)) {
            $criteria->add(StatusTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(StatusTableMap::COL_NAME)) {
            $criteria->add(StatusTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(StatusTableMap::COL_DEFAULT_MESSAGE)) {
            $criteria->add(StatusTableMap::COL_DEFAULT_MESSAGE, $this->default_message);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\Status (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\Status Clone of current object.
     * @throws PropelException
     */

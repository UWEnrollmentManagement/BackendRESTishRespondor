...
/**
 * Base class that represents a row from the 'choice_value' table.
 *
 *
 *
 * @package    propel.generator.FormsAPI.Base
 */
abstract class ChoiceValue implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\FormsAPI\\Map\\ChoiceValueTableMap';
    ...
    /**
     * Initializes internal state of FormsAPI\Base\ChoiceValue object.
     */
    ...
    /**
     * Compares this with another <code>ChoiceValue</code> instance.  If
     * <code>obj</code> is an instance of <code>ChoiceValue</code>, delegates to
     * <code>equals(ChoiceValue)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ChoiceValue The current object, for fluid interface
     */
     ...
     * @return $this|\FormsAPI\ChoiceValue The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ChoiceValueTableMap::COL_ID] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[ChoiceValueTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ChoiceValueTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ChoiceValueTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = ChoiceValueTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\FormsAPI\\ChoiceValue'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildChoiceValueQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ChoiceValue::setDeleted()
     * @see ChoiceValue::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildChoiceValueQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ChoiceValueTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[ChoiceValueTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ChoiceValueTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ChoiceValueTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ChoiceValueTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }

        $sql = sprintf(
            'INSERT INTO choice_value (%s) VALUES (%s)',
    ...
    {
        $pos = ChoiceValueTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ChoiceValue'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ChoiceValue'][$this->hashCode()] = true;
        $keys = ChoiceValueTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\FormsAPI\ChoiceValue
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\FormsAPI\ChoiceValue The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(ChoiceValueTableMap::DATABASE_NAME);

        if ($this->isColumnModified(ChoiceValueTableMap::COL_ID)) {
            $criteria->add(ChoiceValueTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ChoiceValueTableMap::COL_VALUE)) {
            $criteria->add(ChoiceValueTableMap::COL_VALUE, $this->value);
        }
    ...
    {
        $criteria = ChildChoiceValueQuery::create();
        $criteria->add(ChoiceValueTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \FormsAPI\ChoiceValue (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \FormsAPI\ChoiceValue Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildChoiceValue is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildChoiceValue The current object (for fluent API support)
     */
    public function setElementChoices(Collection $elementChoices, ConnectionInterface $con = null)
    {
        ...
        foreach ($elementChoicesToDelete as $elementChoiceRemoved) {
            $elementChoiceRemoved->setChoiceValue(null);
        }
    ...
    protected function doAddElementChoice(ChildElementChoice $elementChoice)
    {
        ...
        $elementChoice->setChoiceValue($this);
    }
    ...
    public function removeElementChoice(ChildElementChoice $elementChoice)
    {
        if ($this->getElementChoices()->contains($elementChoice)) {
            ...
            $elementChoice->setChoiceValue(null);
        }
     ...
     * Otherwise if this ChoiceValue is new, it will return
     * an empty collection; or if this ChoiceValue has previously
     * been saved, it will retrieve related ElementChoices from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in ChoiceValue.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildElementChoice[] List of ChildElementChoice objects
     */
    public function getElementChoicesJoinElement(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildElementChoiceQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(ChoiceValueTableMap::DEFAULT_STRING_FORMAT);
    }
